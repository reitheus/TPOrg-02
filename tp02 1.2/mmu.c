        ...
        *whereWasHit = L2Hit;
        // Just works for Direct Mapping
        {
           int newL1pos = lineWhichWillLeaveLfu(&machine->l1);
            ...
            Line tmp1 = cache1[newL1pos];
            
            if (!canOnlyReplaceBlock(cache1[newL1pos])) { //se nao puder colocar na 1 atualiza na cache2
